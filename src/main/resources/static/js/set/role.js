    ...
    getPageDataUtils(
        {
            ...
            cols: [
                {name: "Id", field: "roleId",  search : true , multipleSelection: false},
                {name: "角色名", field: "roleName",  search : true ,  multipleSelection: false},
                {name: "描述", field: "roleDescribe" ,  search : true },
                {name: "用户", field: "userBeans[n].userName" ,  width : "25%"  ,   search : true },
            ...
            buttons: [
                {
                    buttonName: "编辑",  //按钮名称
                    // buttonType : "other" ,
                    buttonPath : "role/role-inner.html?id=${roleId}" ,  //  删除不要写path
