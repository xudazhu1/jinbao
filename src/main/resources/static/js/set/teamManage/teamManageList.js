   ...
   function test(id) {
        ...
        layer.ready(function () {
            layerIndex = layer.open({
                ...
                maxmin: false,
                area: setpage(),
                content: 'teamMenageEdit.html?id='+id
                ,btn: ['保存','取消'] //按钮
                ,yes: function(index,layero){
                    //  调用内嵌的按钮
                    $(layero).find("iframe").contents().find('.submit button').trigger("click");
        ...
        layui.use(['form', 'table', 'soulTable'], function () {
            ...
            var ins1 = table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'squadGroupFeeNum', title: '编号', width: 100, fixed: 'left'}
                    , {field: 'squadGroupFeeName', title: '班组老板', width: 120}
                    , {field: 'squadGroupFeeCompany', title: '公司名称', sort: true}
                    , {field: 'squadGroupFeeStatusBean', title: '状态', sort: true,hide:true}
                    , {field: 'squadGroupFeeGenre', title: '开票类型', width: 150, sort: true}
                    , {field: 'squadGroupFeeContent', title: '开票类目', width: 200, sort: true}
